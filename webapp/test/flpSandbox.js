		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zcursoapp1bitar-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcursoapp1bitar-display": {
								"semanticObject": "zcursoapp1bitar",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcursoapp1bitar",
									"url": sap.ui.require.toUrl("zcursoapp1bitar")
								}
							}
						}
					}
